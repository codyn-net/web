...
$.extend({
  plotAnimator: function (chart, data,g){
    ...
    for (var __serie = 0; __serie < series.length; __serie++) {
      (function() {
      var serie = series[__serie].index;
      ...
      steps = (data[serie].animator && data[serie].animator.steps) || 135;
      duration = (data[serie].animator && data[serie].animator.duration) || 1000;
    ...
    series[__serie].updateData = function()
    {
      var d3=[];
